...
/**
 * LinkedIn glyph. lucide-react dropped its brand icons (Linkedin, Github, ...)
 * for trademark reasons, so we ship the one mark we need here. Sized to match
 * lucide defaults (1em) and inherits currentColor.
 */
